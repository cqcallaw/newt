...
#ifndef EXPRESSIONS_GET_BYTE_EXPRESSION_H_
#define EXPRESSIONS_GET_BYTE_EXPRESSION_H_

#include <invoke_expression.h>

class GetByteExpression: public InvokeExpression {
public:
	GetByteExpression(const yy::location location,
			const_shared_ptr<Expression> expression,
			const ArgumentListRef argument_list,
			const yy::location argument_list_location);
	virtual ~GetByteExpression();
...
#endif /* EXPRESSIONS_GET_BYTE_EXPRESSION_H_ */
