...
#ifndef EXPRESSIONS_PUT_BYTE_EXPRESSION_H_
#define EXPRESSIONS_PUT_BYTE_EXPRESSION_H_

#include <invoke_expression.h>

class PutByteExpression: public InvokeExpression {
public:
	PutByteExpression(const yy::location location,
			const_shared_ptr<Expression> expression,
			const ArgumentListRef argument_list,
			const yy::location argument_list_location);
	virtual ~PutByteExpression();
